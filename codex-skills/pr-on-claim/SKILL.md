...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/pr-on-claim`, resolve the symlink target for this wrapper directory first,
then read `../../skills/pr-on-claim/SKILL.md` relative to that real directory.
