...
Unlike typical alt text scenarios where you only see an image, **we have access to the code that generates each chart**.
...
Read the caption (`fig-cap`, `fig.cap`) first.
Alt text should **complement, not duplicate** it:
...
**Caption:** "Normalization doesn't make data more normal.
The green curve indicates the density of the unit normal distribution."
