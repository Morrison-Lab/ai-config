...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/delegate-to-codex`, resolve the symlink target for this wrapper directory first,
then read `../../skills/delegate-to-codex/SKILL.md` relative to that real directory.
