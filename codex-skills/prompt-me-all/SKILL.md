...
The source lives at `skills/prompt-me-all/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/prompt-me-all`, resolve the symlink target for this wrapper directory first, then read `../../skills/prompt-me-all/SKILL.md` relative to that real directory.
