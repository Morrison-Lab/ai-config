...
Source: [skills/ct/SKILL.md](../../skills/ct/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/ct/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ct`, resolve the symlink target for this wrapper directory first, then read `../../skills/ct/SKILL.md` relative to that real directory.
