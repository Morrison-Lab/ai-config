...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/find-duplicates`, resolve the symlink target for this wrapper directory first,
then read `../../skills/find-duplicates/SKILL.md` relative to that real directory.
