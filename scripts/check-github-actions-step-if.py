...
Required phrases are scanned only inside this bullet, so an exact copy
elsewhere in the file cannot keep the gate green after this writeup's
sentences are deleted. Deleting the heading is a separate miss
(MISSING_SECTION).
