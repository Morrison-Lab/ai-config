...
- **Secure and private** — no leaked secrets or PHI (the `check-phi`
  capability in
  [`the repository owner/gha`](https://github.com/the repository owner/gha) scans for it),
...
[`gha`'s `CLAUDE.md`](https://github.com/the repository owner/gha/blob/main/CLAUDE.md)
