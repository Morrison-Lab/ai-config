...
Source: [skills/delegate-to-opencode/SKILL.md](../../skills/delegate-to-opencode/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/delegate-to-opencode/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/delegate-to-opencode`, resolve the symlink target for this wrapper directory first, then read `../../skills/delegate-to-opencode/SKILL.md` relative to that real directory.
