...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/r-pkg-check`, resolve the symlink target for this wrapper directory first,
then read `../../skills/r-pkg-check/SKILL.md` relative to that real directory.
