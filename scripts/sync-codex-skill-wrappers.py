...
If this wrapper was loaded through `${{CODEX_HOME:-$HOME/.codex}}/skills/{name}`, resolve the symlink target for this wrapper directory first,\nthen read `../../skills/{name}/SKILL.md` relative to that real directory.
