...
Source: [skills/rec/SKILL.md](../../skills/rec/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/rec/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/rec`, resolve the symlink target for this wrapper directory first, then read `../../skills/rec/SKILL.md` relative to that real directory.
