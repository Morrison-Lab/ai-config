...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/chores`, resolve the symlink target for this wrapper directory first,
then read `../../skills/chores/SKILL.md` relative to that real directory.
