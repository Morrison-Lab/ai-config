...
The source lives at `skills/clean/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/clean`, resolve the symlink target for this wrapper directory first, then read `../../skills/clean/SKILL.md` relative to that real directory.
