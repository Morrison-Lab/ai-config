...
The source lives at `skills/start-task/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/start-task`, resolve the symlink target for this wrapper directory first, then read `../../skills/start-task/SKILL.md` relative to that real directory.
