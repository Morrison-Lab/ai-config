...
The source lives at `skills/drive/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/drive`, resolve the symlink target for this wrapper directory first, then read `../../skills/drive/SKILL.md` relative to that real directory.
