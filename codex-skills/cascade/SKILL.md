...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/cascade`, resolve the symlink target for this wrapper directory first,
then read `../../skills/cascade/SKILL.md` relative to that real directory.
