...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/release-notify`, resolve the symlink target for this wrapper directory first,
then read `../../skills/release-notify/SKILL.md` relative to that real directory.
