...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/brainstorm`, resolve the symlink target for this wrapper directory first,
then read `../../skills/brainstorm/SKILL.md` relative to that real directory.
