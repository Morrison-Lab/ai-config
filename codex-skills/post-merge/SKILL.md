...
The source lives at `skills/post-merge/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/post-merge`, resolve the symlink target for this wrapper directory first, then read `../../skills/post-merge/SKILL.md` relative to that real directory.
