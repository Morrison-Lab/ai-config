...
Source: [skills/cli/SKILL.md](../../skills/cli/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/cli/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/cli`, resolve the symlink target for this wrapper directory first, then read `../../skills/cli/SKILL.md` relative to that real directory.
