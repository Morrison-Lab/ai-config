...
which clears the repo's entire work queue end to end: drive every in-scope open
PR/MR (per `ardia` step 1's scope test) to a clean review verdict with green CI, and open a PR for every open issue that
