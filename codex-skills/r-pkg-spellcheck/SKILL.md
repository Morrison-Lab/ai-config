...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/r-pkg-spellcheck`, resolve the symlink target for this wrapper directory first,
then read `../../skills/r-pkg-spellcheck/SKILL.md` relative to that real directory.
