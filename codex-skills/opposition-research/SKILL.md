...
The source lives at `skills/opposition-research/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/opposition-research`, resolve the symlink target for this wrapper directory first, then read `../../skills/opposition-research/SKILL.md` relative to that real directory.
