...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/mma`, resolve the symlink target for this wrapper directory first,
then read `../../skills/mma/SKILL.md` relative to that real directory.
