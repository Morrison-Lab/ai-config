...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/detect-informal-definitions`, resolve the symlink target for this wrapper directory first,
then read `../../skills/detect-informal-definitions/SKILL.md` relative to that real directory.
