...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/migrate-discussion`, resolve the symlink target for this wrapper directory first,
then read `../../skills/migrate-discussion/SKILL.md` relative to that real directory.
