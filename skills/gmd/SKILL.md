...
Clear the repo's **entire** work queue end to end (`gia`) while acting with full decision latitude (`daytb`) and merge authority (`mwc`).

## When this fires

- "gmd"
- "gia mwc daytb", "/gia /mwc /daytb"
...
3. **[`daytb`](../daytb/SKILL.md)**: You hold latitude to make subjective design or implementation decisions yourself, rather than blocking the loop to ask the user. Apply the option you would have recommended, note it in your report, and keep moving.
