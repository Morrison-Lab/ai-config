...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/sync`, resolve the symlink target for this wrapper directory first,
then read `../../skills/sync/SKILL.md` relative to that real directory.
