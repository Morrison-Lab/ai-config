...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/rc`, resolve the symlink target for this wrapper directory first,
then read `../../skills/rc/SKILL.md` relative to that real directory.
