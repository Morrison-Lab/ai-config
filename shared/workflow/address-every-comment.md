...
HEAD.
This one governs the one that would have run fine, and simply never entered
your check --- because understanding a report means restating it, and the
restatement is what your test ends up encoding.
