...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ard`, resolve the symlink target for this wrapper directory first,
then read `../../skills/ard/SKILL.md` relative to that real directory.
