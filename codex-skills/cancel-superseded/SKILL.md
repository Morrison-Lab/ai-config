...
The source lives at `skills/cancel-superseded/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/cancel-superseded`, resolve the symlink target for this wrapper directory first, then read `../../skills/cancel-superseded/SKILL.md` relative to that real directory.
