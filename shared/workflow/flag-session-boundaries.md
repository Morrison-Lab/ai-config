...
(Measured 2026-08-19 on `Morrison-Lab/rme`.
Installing this corpus as a plugin in that repo's `@claude` workflow ([rme#1076](https://github.com/Morrison-Lab/rme/pull/1076)) made every prose reply collapse to a one-line declaration.
...
[rme#1082](https://github.com/Morrison-Lab/rme/pull/1082) is the consumer-side workaround, and this section is the upstream fix that stops it recurring in every other repo installing the plugin.)
