...
The source lives at `skills/dmmhyh/SKILL.md` in the same ai-config checkout as this wrapper. If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/dmmhyh`, resolve the symlink target for this wrapper directory first, then read `../../skills/dmmhyh/SKILL.md` relative to that real directory. Do not resolve that relative path from inside `${CODEX_HOME:-$HOME/.codex}/skills`, because it points back at the wrapper tree.
