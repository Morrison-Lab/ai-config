...
Determine the optimal execution environment (harness CLI or IDE), billing provider tier, model capability, and review engine for a repository, issue, or task. Aliases: [`rech`](../../skills/rech/SKILL.llms.md) (recommend harness), [`rechme`](../../skills/rechme/SKILL.llms.md) (recommend harness/model/engine).
...
- **Local Multi-Engine Review**: Dispatch via [`adv`](../../skills/adv/SKILL.llms.md) (`pre-push-review.py`).
...
- Is the task a heavy, parallelizable read / audit / draft of multiple files?
  - **YES** → Route to sidecar CLI (`codex` or `opencode` free) via [`delegate-to-codex`](../../skills/delegate-to-codex/SKILL.llms.md) or [`delegate-to-opencode`](../../skills/delegate-to-opencode/SKILL.llms.md).
...
- Use [`adv`](../../skills/adv/SKILL.llms.md) / Sonnet 4.6 subagent for pre-push review against `git diff origin/<default-branch>...HEAD`.
...
- **[`select-model`](../../skills/select-model/SKILL.llms.md)**: Focuses narrowly on choosing among Claude model tiers (Fable, Haiku, Sonnet, Opus).
- **[`assess-model-fit`](../../skills/assess-model-fit/SKILL.llms.md)**: Assesses whether the active model tier is struggling and warrants escalation.
- **[`delegate-to-codex`](../../skills/delegate-to-codex/SKILL.llms.md) (`dtc`)**: Operationalizes background dispatch, schema enforcement, and fallback mechanics for Codex.
- **[`delegate-to-opencode`](../../skills/delegate-to-opencode/SKILL.llms.md) (`dto`)**: Operationalizes dispatch to OpenCode free, Go, and OpenRouter tiers.
- **[`adv`](../../skills/adv/SKILL.llms.md)**: Operationalizes multi-engine adversarial code review prior to pushing.
