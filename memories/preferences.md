...
- **When unsure whether the user wants an action taken, default to doing it (if reversible and in-scope) rather than asking --- the user names the exceptions.**
  ...
  Recurred 2026-08-23 ("Not committed --- say the word if you'd like a branch + PR"; user: "always yes --- remember that"); now encoded agent-universally in `AGENTS.md`'s "Default to action without asking".)
