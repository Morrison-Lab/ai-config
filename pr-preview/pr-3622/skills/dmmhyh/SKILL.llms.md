...
3.  **Persist the correction as feedback**, so the next session starts already calibrated instead of relearning this from scratch. This skill’s Procedure makes that step mandatory rather than optional.
