...
The source lives at `skills/merge-main/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/merge-main`, resolve the symlink target for this wrapper directory first, then read `../../skills/merge-main/SKILL.md` relative to that real directory.
