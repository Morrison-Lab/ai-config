...
- **All recorded facts about software, APIs, harnesses, and technologies must carry temporal qualifications and provenance.**
  ...
  Do: attach explicit observation date, version number, commit snapshot, or runtime environment, and include a re-verification reminder (per `shared/writing/timestamp-volatile-claims.md`).
