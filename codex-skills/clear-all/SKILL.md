...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/clear-all`, resolve the symlink target for this wrapper directory first,
then read `../../skills/clear-all/SKILL.md` relative to that real directory.
