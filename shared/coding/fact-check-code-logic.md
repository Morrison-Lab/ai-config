...
(Measured 2026-09-02 Pacific on [ai-config#3023](https://github.com/Morrison-Lab/ai-config/pull/3023), whose own body records "Nine adversarial rounds, 34 findings", several rounds finding a real defect in the previous round's fix.
