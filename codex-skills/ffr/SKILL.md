...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ffr`, resolve the symlink target for this wrapper directory first,
then read `../../skills/ffr/SKILL.md` relative to that real directory.
