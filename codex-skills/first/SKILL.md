...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/first`, resolve the symlink target for this wrapper directory first,
then read `../../skills/first/SKILL.md` relative to that real directory.
