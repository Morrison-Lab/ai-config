...
The source lives at `skills/handoff/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/handoff`, resolve the symlink target for this wrapper directory first, then read `../../skills/handoff/SKILL.md` relative to that real directory.
