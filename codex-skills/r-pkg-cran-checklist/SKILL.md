...
The source lives at `skills/r-pkg-cran-checklist/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/r-pkg-cran-checklist`, resolve the symlink target for this wrapper directory first, then read `../../skills/r-pkg-cran-checklist/SKILL.md` relative to that real directory.
