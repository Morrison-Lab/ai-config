...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/next`, resolve the symlink target for this wrapper directory first,
then read `../../skills/next/SKILL.md` relative to that real directory.
