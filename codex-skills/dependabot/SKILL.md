...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/dependabot`, resolve the symlink target for this wrapper directory first,
then read `../../skills/dependabot/SKILL.md` relative to that real directory.
