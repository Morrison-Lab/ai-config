...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/remember`, resolve the symlink target for this wrapper directory first,
then read `../../skills/remember/SKILL.md` relative to that real directory.
