...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/perf`, resolve the symlink target for this wrapper directory first,
then read `../../skills/perf/SKILL.md` relative to that real directory.
