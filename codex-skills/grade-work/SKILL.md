...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/grade-work`, resolve the symlink target for this wrapper directory first,
then read `../../skills/grade-work/SKILL.md` relative to that real directory.
