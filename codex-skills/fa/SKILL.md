...
The source lives at `skills/fa/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/fa`, resolve the symlink target for this wrapper directory first, then read `../../skills/fa/SKILL.md` relative to that real directory.
