...
The source lives at `skills/revive-closed/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/revive-closed`, resolve the symlink target for this wrapper directory first, then read `../../skills/revive-closed/SKILL.md` relative to that real directory.
