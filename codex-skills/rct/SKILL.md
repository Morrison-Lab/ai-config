...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/rct`, resolve the symlink target for this wrapper directory first,
then read `../../skills/rct/SKILL.md` relative to that real directory.
