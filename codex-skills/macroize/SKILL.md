...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/macroize`, resolve the symlink target for this wrapper directory first,
then read `../../skills/macroize/SKILL.md` relative to that real directory.
