...
REMIND = [
    ...
    ([Q, tool("Bash", {"command": "true"}), user("also check the other figure"),
      CONTRAST],
     "a tool-only turn does not close the question window"),
...
SILENT = [
    ...
    ([user("the matcher looks for `### Verdict`")],
     "naming the verdict heading in inline code is not a review-read"),
