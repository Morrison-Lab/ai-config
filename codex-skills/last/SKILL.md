...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/last`, resolve the symlink target for this wrapper directory first,
then read `../../skills/last/SKILL.md` relative to that real directory.
