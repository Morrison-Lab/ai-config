...
Recorded from a session on `the repository owner/rme`
covering rme#1068, #1073, #1074, #1076 and #1086,
and filed for transfer as
[rme#1089](https://github.com/the repository owner/rme/issues/1089).
...
Re-measured 2026-08-20 on `the repository owner/rme` at `main`:
