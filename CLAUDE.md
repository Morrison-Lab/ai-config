...
`hooks/no-push-without-self-review.py` gates the pre-push case; the fragment covers the rest, including why a same-vendor subagent buys independence of *intent* and not of blind spot.
