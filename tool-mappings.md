...
| `MERGE_PR` | Merge a pull request, pinned to the head the clean gate evaluated. | `gh pr merge "<N>" --match-head-commit "<sha>"` | `mcp__github__merge_pull_request (expectedHeadSha="<sha>")` |
