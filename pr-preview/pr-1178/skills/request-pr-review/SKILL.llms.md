...
A skill that routes its request through this skill inherits the exception automatically, so `ard`, `ardi`, `merge-it`, and `st` need no edit. Each is cross-repo, and each defers here.
