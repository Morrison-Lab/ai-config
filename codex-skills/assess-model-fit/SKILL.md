...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/assess-model-fit`, resolve the symlink target for this wrapper directory first,
then read `../../skills/assess-model-fit/SKILL.md` relative to that real directory.
