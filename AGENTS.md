...
- **Never bare `git push --force`.**
  ...
  `git ls-remote --heads origin <branch>` settles existence: empty means the branch is gone, and non-empty means compare its tip against the ref you are pushing before choosing a remedy.
