...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/agent-builder`, resolve the symlink target for this wrapper directory first,
then read `../../skills/agent-builder/SKILL.md` relative to that real directory.
