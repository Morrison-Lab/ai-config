...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/delegate-to-opencode`, resolve the symlink target for this wrapper directory first,
then read `../../skills/delegate-to-opencode/SKILL.md` relative to that real directory.
