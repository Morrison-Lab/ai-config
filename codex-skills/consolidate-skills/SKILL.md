...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/consolidate-skills`, resolve the symlink target for this wrapper directory first,
then read `../../skills/consolidate-skills/SKILL.md` relative to that real directory.
