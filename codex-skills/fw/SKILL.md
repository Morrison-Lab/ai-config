...
Source: [skills/fw/SKILL.md](../../skills/fw/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/fw/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/fw`, resolve the symlink target for this wrapper directory first, then read `../../skills/fw/SKILL.md` relative to that real directory.
