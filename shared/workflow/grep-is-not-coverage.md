...
`grep -rl 'generated by' .` answers it for the whole tree at once, and [`ardi.rationale.md`](ardi.rationale.md)'s "When regenerating a generated tree makes it most of the diff" covers the editing half.
