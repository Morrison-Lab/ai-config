...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/style`, resolve the symlink target for this wrapper directory first,
then read `../../skills/style/SKILL.md` relative to that real directory.
