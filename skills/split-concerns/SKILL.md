...
- CI/workflow infrastructure change + precomputed simulation/validation dataset artifacts (e.g. `inst/extdata/*.rds`, `.parquet`, `.RData`) or HPC job array updates → split
