...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/simplify`, resolve the symlink target for this wrapper directory first,
then read `../../skills/simplify/SKILL.md` relative to that real directory.
