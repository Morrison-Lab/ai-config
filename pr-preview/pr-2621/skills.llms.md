...
| [`claim-pr`](skills/claim-pr/SKILL.llms.md) |  | Post a claim comment before a work session; unclaim when done |
...
| [`cran-extrachecks`](skills/cran-extrachecks/SKILL.llms.md) |  | Check the ad-hoc CRAN requirements `devtools::check()` doesn’t catch |
| [`create-release-checklist`](skills/create-release-checklist/SKILL.llms.md) |  | File a GitHub issue with a release checklist for an R package |
| [`r-package-development`](skills/r-package-development/SKILL.llms.md) |  | Day-to-day R package dev loop: load, test, document, format |
| [`testing-r-packages`](skills/testing-r-packages/SKILL.llms.md) |  | Full testthat reference: fixtures, mocking, snapshots, BDD-style tests |
