...
The source lives at `skills/away/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/away`, resolve the symlink target for this wrapper directory first, then read `../../skills/away/SKILL.md` relative to that real directory.
