...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/push`, resolve the symlink target for this wrapper directory first,
then read `../../skills/push/SKILL.md` relative to that real directory.
