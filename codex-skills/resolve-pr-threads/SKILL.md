...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/resolve-pr-threads`, resolve the symlink target for this wrapper directory first, then read `../../skills/resolve-pr-threads/SKILL.md` relative to that real directory.
