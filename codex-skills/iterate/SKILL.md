...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/iterate`, resolve the symlink target for this wrapper directory first,
then read `../../skills/iterate/SKILL.md` relative to that real directory.
