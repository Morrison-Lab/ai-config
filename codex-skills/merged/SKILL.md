...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/merged`, resolve the symlink target for this wrapper directory first,
then read `../../skills/merged/SKILL.md` relative to that real directory.
