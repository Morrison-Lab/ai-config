...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/link-skills`, resolve the symlink target for this wrapper directory first,
then read `../../skills/link-skills/SKILL.md` relative to that real directory.
