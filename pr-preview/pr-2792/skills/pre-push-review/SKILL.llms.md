...
Runs an automated, single-pass adversarial AI code review on outgoing branch commits, drawing on desktop **Claude Pro/Team**, **ChatGPT**, **OpenCode**, or **Google AI Ultra** subscription quota.
