...
The source lives at `skills/fact-check-prose/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/fact-check-prose`, resolve the symlink target for this wrapper directory first, then read `../../skills/fact-check-prose/SKILL.md` relative to that real directory.
