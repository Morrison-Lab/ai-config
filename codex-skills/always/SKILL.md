...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/always`, resolve the symlink target for this wrapper directory first,
then read `../../skills/always/SKILL.md` relative to that real directory.
