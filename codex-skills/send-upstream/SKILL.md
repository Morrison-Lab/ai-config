...
The source lives at `skills/send-upstream/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/send-upstream`, resolve the symlink target for this wrapper directory first, then read `../../skills/send-upstream/SKILL.md` relative to that real directory.
