...
- **Example**: wai session 2026-08-19: wrote content, committed, but stopped before pushing/opening a PR.
...
- **Example**: wai session 2026-08-19: corrected three times (didn't push, didn't open PR, declared ready with failing CI).
