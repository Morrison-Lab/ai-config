...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/giardia`, resolve the symlink target for this wrapper directory first,
then read `../../skills/giardia/SKILL.md` relative to that real directory.
