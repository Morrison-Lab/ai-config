...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/update-memories-and-skills`, resolve the symlink target for this wrapper directory first,
then read `../../skills/update-memories-and-skills/SKILL.md` relative to that real directory.
