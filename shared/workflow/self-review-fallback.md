...
- **Do:** run `adversarial-reviewer`, `fact-check-prose`, the **cause** check, and the cited-source check on a fallback self-review, exactly as on any pre-push self-review.
