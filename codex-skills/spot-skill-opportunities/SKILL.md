...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/spot-skill-opportunities`, resolve the symlink target for this wrapper directory first,
then read `../../skills/spot-skill-opportunities/SKILL.md` relative to that real directory.
