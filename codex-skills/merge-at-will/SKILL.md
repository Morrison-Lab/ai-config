...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/merge-at-will`, resolve the symlink target for this wrapper directory first,
then read `../../skills/merge-at-will/SKILL.md` relative to that real directory.
