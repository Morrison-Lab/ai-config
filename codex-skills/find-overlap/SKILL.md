...
The source lives at `skills/find-overlap/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/find-overlap`, resolve the symlink target for this wrapper directory first, then read `../../skills/find-overlap/SKILL.md` relative to that real directory.
