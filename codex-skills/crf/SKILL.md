...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/crf`, resolve the symlink target for this wrapper directory first,
then read `../../skills/crf/SKILL.md` relative to that real directory.
