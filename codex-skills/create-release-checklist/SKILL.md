...
Source: [skills/create-release-checklist/SKILL.md](../../skills/create-release-checklist/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/create-release-checklist/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/create-release-checklist`, resolve the symlink target for this wrapper directory first, then read `../../skills/create-release-checklist/SKILL.md` relative to that real directory.
