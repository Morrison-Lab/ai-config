...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/use-math-macros`, resolve the symlink target for this wrapper directory first,
then read `../../skills/use-math-macros/SKILL.md` relative to that real directory.
