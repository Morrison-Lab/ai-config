...
- **`claim-pr`** — posts/removes the “paws off” claim comment this skill reads in check \#3. `push` is the read side; `claim-pr` is the write side.
