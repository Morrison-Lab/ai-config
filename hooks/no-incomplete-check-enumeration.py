...
def main() -> int:
    ...
    print(json.dumps({
        ...
        "reason": (
            ...
            "Run an instrument that can authorize the claim, then report from it:\n\n"
            ...
            "That check-runs read does not cover review criteria; pair it with them "
            "before a terminal fully-clean claim. "
