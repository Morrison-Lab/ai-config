...
both `Morrison-Lab/ai-config` and `the repository owner/ai-config` publish a plugin
...
A few fragments are authored in **[the repository owner/wai](https://github.com/the repository owner/wai)**
