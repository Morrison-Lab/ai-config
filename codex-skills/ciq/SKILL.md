...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ciq`, resolve the symlink target for this wrapper directory first,
then read `../../skills/ciq/SKILL.md` relative to that real directory.
