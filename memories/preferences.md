...
- NEVER assume; ALWAYS verify.
  ...
  **Third recorded recurrence, 2026-08-26:** work on `ucdavis/rampp#140` began from a checkout last current on 2026-07-19, although the issue and its implementing PR had merged on 2026-07-22; the redundant local edits were retired after fresh checks of the issue and remote state. Because the written rule has now failed three times, the deterministic pre-edit guard is tracked in [ai-config#2282](https://github.com/Morrison-Lab/ai-config/issues/2282).
