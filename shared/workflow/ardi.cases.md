...
(the repository owner/altdoc#54, 2026-07-25: two review fixes were edited locally and a
...
(the repository owner/altdoc#76, 2026-07-27: the PR body said roxygen2 8.0.0 --- the
...
(the repository owner/altdoc#78, 2026-07-27: a generator-to-extension map gave mkdocs
...
(the repository owner/altdoc#78, 2026-07-27: twice.
...
(the repository owner/altdoc#78, 2026-07-27: a commit written to get ahead of a
...
(the repository owner/altdoc#95 and #96, 2026-07-29: twice in one session.
...
([gha#219](https://github.com/the repository owner/gha/issues/219)/[#220](https://github.com/the repository owner/gha/pull/220): one review round surfaced five findings --- a DRY
...
([the repository owner/rme#989](https://github.com/the repository owner/rme/pull/989) /
...
(the repository owner/altdoc#34: running the new reference-index generator
against `the repository owner/rpt` covered a `\docType{package}` topic, the singular
...
(the repository owner/altdoc#73: the issue proposed ending a function with a bare
...
(the repository owner/altdoc#76: a guard checked for the copied logo under `docs/`,
