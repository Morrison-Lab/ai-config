...
# clean-git (Codex wrapper)

This is a generated Codex wrapper around the canonical ai-config Claude skill.

Source: [skills/clean-git/SKILL.md](../../skills/clean-git/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/clean-git/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/clean-git`, resolve the symlink target for this wrapper directory first, then read `../../skills/clean-git/SKILL.md` relative to that real directory.
