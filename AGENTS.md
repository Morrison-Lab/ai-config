...
only when the repository membership check above is satisfied
...
Continue monitoring until the item merges, closes,
or the user explicitly releases the agent from it.
