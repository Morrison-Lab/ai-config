...
The source lives at `skills/ts/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ts`, resolve the symlink target for this wrapper directory first, then read `../../skills/ts/SKILL.md` relative to that real directory.
