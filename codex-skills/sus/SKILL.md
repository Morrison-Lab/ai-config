...
The source lives at `skills/sus/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/sus`, resolve the symlink target for this wrapper directory first, then read `../../skills/sus/SKILL.md` relative to that real directory.
