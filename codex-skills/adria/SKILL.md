...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/adria`, resolve the symlink target for this wrapper directory first,
then read `../../skills/adria/SKILL.md` relative to that real directory.
