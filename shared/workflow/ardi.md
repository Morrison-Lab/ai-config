...
- **Do:** re-run the project-conventions check against your own diff after a
  clean verdict, not only before the push --- dispatched to the
  [`adversarial-reviewer`](../../.claude/agents/adversarial-reviewer.md)
  subagent like any other self-review
  ([`adversarial-self-review`](adversarial-self-review.md)), rather than
  performed inline.
