...
# finish-wave (Codex wrapper)

This is a generated Codex wrapper around the canonical ai-config Claude skill.

Source: [skills/finish-wave/SKILL.md](../../skills/finish-wave/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/finish-wave/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/finish-wave`, resolve the symlink target for this wrapper directory first, then read `../../skills/finish-wave/SKILL.md` relative to that real directory.
