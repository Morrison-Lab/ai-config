...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/slide-tag`, resolve the symlink target for this wrapper directory first,
then read `../../skills/slide-tag/SKILL.md` relative to that real directory.
