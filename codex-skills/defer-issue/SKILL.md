...
The source lives at `skills/defer-issue/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/defer-issue`, resolve the symlink target for this wrapper directory first, then read `../../skills/defer-issue/SKILL.md` relative to that real directory.
