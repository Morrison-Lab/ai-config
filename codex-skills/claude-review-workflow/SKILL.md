...
The source lives at `skills/claude-review-workflow/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/claude-review-workflow`, resolve the symlink target for this wrapper directory first, then read `../../skills/claude-review-workflow/SKILL.md` relative to that real directory.
