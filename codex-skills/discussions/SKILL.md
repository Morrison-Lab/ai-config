...
The source lives at `skills/discussions/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/discussions`, resolve the symlink target for this wrapper directory first, then read `../../skills/discussions/SKILL.md` relative to that real directory.
