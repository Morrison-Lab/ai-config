...
The source lives at `skills/claim-pr/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/claim-pr`, resolve the symlink target for this wrapper directory first, then read `../../skills/claim-pr/SKILL.md` relative to that real directory.
