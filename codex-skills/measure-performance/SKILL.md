...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/measure-performance`, resolve the symlink target for this wrapper directory first,
then read `../../skills/measure-performance/SKILL.md` relative to that real directory.
