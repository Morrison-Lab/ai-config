...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/clean-git`, resolve the symlink target for this wrapper directory first,
then read `../../skills/clean-git/SKILL.md` relative to that real directory.
