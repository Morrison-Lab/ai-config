...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ardi`, resolve the symlink target for this wrapper directory first,
then read `../../skills/ardi/SKILL.md` relative to that real directory.
