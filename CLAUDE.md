...
Read "work" broadly --- the rule is not about judgment but about doing by hand what something else already computes, which includes work carrying no judgment at all.
A hand-typed section number is nobody's decision; it is a value the renderer already produces, kept in a second place by hand, and it goes wrong the moment anything enables the real generator.
