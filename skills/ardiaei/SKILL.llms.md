...
- Phase 1 drives each PR per ARDIA’s own terminal states: clean, deadlocked on a specific item, or blocked. A round count is not one of them — see [`ardi`](../../skills/ardi/SKILL.llms.md)’s “Stopping conditions”.
