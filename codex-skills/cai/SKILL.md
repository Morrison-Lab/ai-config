...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/cai`, resolve the symlink target for this wrapper directory first,
then read `../../skills/cai/SKILL.md` relative to that real directory.
