...
This topic now lives in
[`claude-code-consumer-wiring.md`](claude-code-consumer-wiring.md) ---
split out at the 1200-line gate (see that file for the `bootstrap.sh`
vs. bot wiring, the committed symlink, and the shallow-clone caveats).
