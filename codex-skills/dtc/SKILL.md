...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/dtc`, resolve the symlink target for this wrapper directory first,
then read `../../skills/dtc/SKILL.md` relative to that real directory.
