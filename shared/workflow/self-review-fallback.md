...
Re-check reachability at the start of every cycle: a reviewer that was ineligible/quota-exhausted a few pushes ago (a missing license, a temporary rate limit) can become reachable mid-session,
