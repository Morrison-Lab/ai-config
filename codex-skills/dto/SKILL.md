...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/dto`, resolve the symlink target for this wrapper directory first,
then read `../../skills/dto/SKILL.md` relative to that real directory.
