...
CASES = [
    ...
    ([say("Running unit tests. Scheduled check-in at 2026-08-31 09:02:15 PDT.")],
     True, "an un-armed 'Scheduled check-in at' claim blocks as an empty promise"),
    ([say("Next check-in at 2026-08-31 09:02:15 PDT.")],
     True, "an un-armed 'Next check-in at' claim blocks as an empty promise"),
    ([say("The scheduled check at 09:02:15 PDT already fired; CI is green, all findings addressed.")],
     False, "a retrospective 'scheduled check at ... already fired' does not block"),
    ([say("The scheduled check-in at 09:02:15 PDT finished with all green.")],
     False, "a retrospective 'scheduled check-in at ... finished' does not block"),
    ([say("The scheduled check at 09:02:15 PDT was clean.")],
     False, "a retrospective 'scheduled check at ... was clean' does not block"),
    ([say("Running unit tests. Scheduled check at 2026-08-31 09:02:15 PDT."),
      {"type": "assistant", "message": {"content": [
          {"type": "tool_use", "name": "ScheduleWakeup",
