...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/dmmhyh`, resolve the symlink target for this wrapper directory first,
then read `../../skills/dmmhyh/SKILL.md` relative to that real directory.
