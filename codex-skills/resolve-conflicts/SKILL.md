...
The source lives at `skills/resolve-conflicts/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/resolve-conflicts`, resolve the symlink target for this wrapper directory first, then read `../../skills/resolve-conflicts/SKILL.md` relative to that real directory.
