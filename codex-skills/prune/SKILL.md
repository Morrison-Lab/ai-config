...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/prune`, resolve the symlink target for this wrapper directory first,
then read `../../skills/prune/SKILL.md` relative to that real directory.
