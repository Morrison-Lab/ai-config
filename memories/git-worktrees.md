...
Git history does.
A remote session's commits carry a `Claude-Session:` trailer holding that session's own URL, so comparing it against your own settles authorship instead of suggesting it.
