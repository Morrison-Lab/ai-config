...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ardiaei`, resolve the symlink target for this wrapper directory first,
then read `../../skills/ardiaei/SKILL.md` relative to that real directory.
