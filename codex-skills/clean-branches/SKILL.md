...
The source lives at `skills/clean-branches/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/clean-branches`, resolve the symlink target for this wrapper directory first, then read `../../skills/clean-branches/SKILL.md` relative to that real directory.
