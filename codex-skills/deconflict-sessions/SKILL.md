...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/deconflict-sessions`, resolve the symlink target for this wrapper directory first,
then read `../../skills/deconflict-sessions/SKILL.md` relative to that real directory.
