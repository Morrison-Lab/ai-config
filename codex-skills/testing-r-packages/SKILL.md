...
# testing-r-packages (Codex wrapper)

This is a generated Codex wrapper around the canonical ai-config Claude skill.

Source: [skills/testing-r-packages/SKILL.md](../../skills/testing-r-packages/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/testing-r-packages/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/testing-r-packages`, resolve the symlink target for this wrapper directory first, then read `../../skills/testing-r-packages/SKILL.md` relative to that real directory.
