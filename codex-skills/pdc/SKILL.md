...
Source: [skills/pdc/SKILL.md](../../skills/pdc/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/pdc/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/pdc`, resolve the symlink target for this wrapper directory first, then read `../../skills/pdc/SKILL.md` relative to that real directory.
