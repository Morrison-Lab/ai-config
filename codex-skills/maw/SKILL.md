...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/maw`, resolve the symlink target for this wrapper directory first, then read `../../skills/maw/SKILL.md` relative to that real directory.
