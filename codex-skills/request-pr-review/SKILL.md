...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/request-pr-review`, resolve the symlink target for this wrapper directory first,
then read `../../skills/request-pr-review/SKILL.md` relative to that real directory.
