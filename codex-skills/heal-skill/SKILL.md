...
The source lives at `skills/heal-skill/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/heal-skill`, resolve the symlink target for this wrapper directory first, then read `../../skills/heal-skill/SKILL.md` relative to that real directory.
