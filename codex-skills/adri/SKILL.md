...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/adri`, resolve the symlink target for this wrapper directory first,
then read `../../skills/adri/SKILL.md` relative to that real directory.
