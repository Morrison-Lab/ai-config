...
| `no-redundant-push-pr-authorization.py` | `Stop` | blocks a request for routine push or PR/MR authorization already covered by the standing grant; deliberately leaves merge and force-push questions alone |
