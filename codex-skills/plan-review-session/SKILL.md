...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/plan-review-session`, resolve the symlink target for this wrapper directory first,
then read `../../skills/plan-review-session/SKILL.md` relative to that real directory.
