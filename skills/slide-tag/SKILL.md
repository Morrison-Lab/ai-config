...
for the `the repository owner/macros` submodule as part of a broader macro-conversion
...
history: sliding the `macros` submodule pin in `the repository owner/rme`#983 and
