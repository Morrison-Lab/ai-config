...
# brand-yml (Codex wrapper)

This is a generated Codex wrapper around the canonical ai-config Claude skill.

Source: [skills/brand-yml/SKILL.md](../../skills/brand-yml/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/brand-yml/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/brand-yml`, resolve the symlink target for this wrapper directory first, then read `../../skills/brand-yml/SKILL.md` relative to that real directory.
