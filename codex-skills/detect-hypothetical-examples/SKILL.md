...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/detect-hypothetical-examples`, resolve the symlink target for this wrapper directory first,
then read `../../skills/detect-hypothetical-examples/SKILL.md` relative to that real directory.
