...
- NEVER assume; ALWAYS verify.
  ...
  If state is MERGED, trigger post-merge instead of reporting CI details. (Learned on ucdavis/bcs#266; recurred on Morrison-Lab/ai-config#2876, 2026-09-01, when a cached pre-merge PR status was reported after the PR had merged.)
