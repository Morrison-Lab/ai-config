...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/skill-audit`, resolve the symlink target for this wrapper directory first,
then read `../../skills/skill-audit/SKILL.md` relative to that real directory.
