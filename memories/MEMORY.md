...
| [`github-actions-outages.md`](github-actions-outages.md) | GitHub Actions platform outages | Detecting a live incident (absent rather than failing checks, the `githubstatus.com` JSON endpoints, the plural-versus-single tell) and cleaning up after one (a swallowed push versus jobs cancelled mid-flight, and why zero recorded steps is the discriminator). Split out of `github-actions.md` (ai-config#694 pattern) at the 1200-line gate. |
