...
The source lives at `skills/merge-when-confident/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/merge-when-confident`, resolve the symlink target for this wrapper directory first, then read `../../skills/merge-when-confident/SKILL.md` relative to that real directory.
