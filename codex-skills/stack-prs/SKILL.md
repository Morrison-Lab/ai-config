...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/stack-prs`, resolve the symlink target for this wrapper directory first,
then read `../../skills/stack-prs/SKILL.md` relative to that real directory.
