...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/scout-peers`, resolve the symlink target for this wrapper directory first,
then read `../../skills/scout-peers/SKILL.md` relative to that real directory.
