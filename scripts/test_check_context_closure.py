...
# stay at 72 anchored imports whatever the fence handling does. (Was 69 until
...
# added @shared/writing/ambiguous-reference.md.)
check(
    "this repo's CLAUDE.md still yields 72 anchored imports",
