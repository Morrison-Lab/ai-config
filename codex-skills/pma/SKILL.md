...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/pma`, resolve the symlink target for this wrapper directory first,
then read `../../skills/pma/SKILL.md` relative to that real directory.
