...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/sup`, resolve the symlink target for this wrapper directory first, then read `../../skills/sup/SKILL.md` relative to that real directory.
