...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/prompt-me`, resolve the symlink target for this wrapper directory first,
then read `../../skills/prompt-me/SKILL.md` relative to that real directory.
