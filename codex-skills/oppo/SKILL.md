...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/oppo`, resolve the symlink target for this wrapper directory first,
then read `../../skills/oppo/SKILL.md` relative to that real directory.
