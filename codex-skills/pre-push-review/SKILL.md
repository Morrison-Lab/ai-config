...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/pre-push-review`, resolve the symlink target for this wrapper directory first,
then read `../../skills/pre-push-review/SKILL.md` relative to that real directory.
