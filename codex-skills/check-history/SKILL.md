...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/check-history`, resolve the symlink target for this wrapper directory first,
then read `../../skills/check-history/SKILL.md` relative to that real directory.
