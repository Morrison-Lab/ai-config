...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/config-ai`, resolve the symlink target for this wrapper directory first,
then read `../../skills/config-ai/SKILL.md` relative to that real directory.
