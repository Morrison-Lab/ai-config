...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/merge-it`, resolve the symlink target for this wrapper directory first,
then read `../../skills/merge-it/SKILL.md` relative to that real directory.
