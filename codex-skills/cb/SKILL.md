...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/cb`, resolve the symlink target for this wrapper directory first,
then read `../../skills/cb/SKILL.md` relative to that real directory.
