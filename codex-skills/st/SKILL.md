...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/st`, resolve the symlink target for this wrapper directory first,
then read `../../skills/st/SKILL.md` relative to that real directory.
