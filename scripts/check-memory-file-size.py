...
scripts/test_check_memory_file_size.py; a same-day rewrite that kept
three existing lines in place passed this test and had to satisfy
new-line-breaks instead.
