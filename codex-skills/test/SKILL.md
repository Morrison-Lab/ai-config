...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/test`, resolve the symlink target for this wrapper directory first,
then read `../../skills/test/SKILL.md` relative to that real directory.
