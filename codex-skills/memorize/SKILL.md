...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/memorize`, resolve the symlink target for this wrapper directory first,
then read `../../skills/memorize/SKILL.md` relative to that real directory.
