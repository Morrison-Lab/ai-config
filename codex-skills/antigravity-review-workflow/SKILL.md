...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/antigravity-review-workflow`, resolve the symlink target for this wrapper directory first,
then read `../../skills/antigravity-review-workflow/SKILL.md` relative to that real directory.
