...
There is a one-command derivation, and it is independent of the verdict clock the section above measures:
...
- **Do:** derive a peer’s liveness from `git log -1 --format=%cI origin/<branch>` before writing anything about it, and put the timestamp in the comment.
