...
The source lives at `skills/adr/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/adr`, resolve the symlink target for this wrapper directory first, then read `../../skills/adr/SKILL.md` relative to that real directory.
