...
Source: [skills/ep/SKILL.md](../../skills/ep/SKILL.md)

Before acting, read the source skill completely and follow its workflow, adapting it to Codex.

The source lives at `skills/ep/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/ep`, resolve the symlink target for this wrapper directory first, then read `../../skills/ep/SKILL.md` relative to that real directory.
