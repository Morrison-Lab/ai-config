...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/register-oaicopilot-models`, resolve the symlink target for this wrapper directory first, then read `../../skills/register-oaicopilot-models/SKILL.md` relative to that real directory.
