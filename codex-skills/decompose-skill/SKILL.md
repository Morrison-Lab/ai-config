...
The source lives at `skills/decompose-skill/SKILL.md` in the same ai-config checkout as this wrapper.
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/decompose-skill`, resolve the symlink target for this wrapper directory first, then read `../../skills/decompose-skill/SKILL.md` relative to that real directory.
