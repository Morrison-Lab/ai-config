...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/check-rendered-refs`, resolve the symlink target for this wrapper directory first,
then read `../../skills/check-rendered-refs/SKILL.md` relative to that real directory.
