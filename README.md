...
| `no-silent-traceback.py` | `PostToolUse` (Bash) | warns, never blocks, when a successful Bash call's output carries a line-anchored Python traceback (ai-config#1684) |
