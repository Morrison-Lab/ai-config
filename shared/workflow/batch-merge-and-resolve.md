...
#961 --- of which #943 and #951 have since merged.
A pairwise sweep of the 8 heads then open found **2 of 8** conflicting with
`main` and **9 of 28** pairs conflicting with each other, including #953 and
#961, which were each clean against `main` and conflicted with one another on
