...
If this wrapper was loaded through `${CODEX_HOME:-$HOME/.codex}/skills/fetch-all`, resolve the symlink target for this wrapper directory first,
then read `../../skills/fetch-all/SKILL.md` relative to that real directory.
